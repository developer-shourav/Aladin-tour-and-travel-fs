...
const ManageAllOrders = () => {
    ...
    const handleUpdate = id => {
        fetch(`https://rocky-dawn-01056.herokuapp.com/updateStatus/${id}`,{
            method: "PUT",
                                            ...
                                            <div className="row">
                                                <div className="col-lg-8 d-flex align-items-center">
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center ms-3">
                                                        ...
                                                        <div className="a"><h4 className="m-0">Package: {order?.packageName}</h4><p  className="mt-2 mb-2 fs-5">Class:{order?.model}</p>
                                                ...
                                                <div className="col-lg-4 d-flex align-items-center">
                                                    ...
                                                    <div className="ms-5 mt-4 mt-lg-0">
                                                        <button onClick={() => handleUpdate(order?._id)}className="btn btn-success ms-4" >Approve Order</button>
                                                        
                                                        <button onClick={() => handleDelete(order?._id)}  className="btn btn-danger ms-4 mt-3"><i className="fas fa-trash" aria-hidden="true"></i> Delete Order</button>
                                                    </div>
                                                </div>
